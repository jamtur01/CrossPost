...
/// Console/`log stream` without surfacing anything to the user. Log context
/// (feed kind, target) `.public`; interpolate error text with default privacy,
/// since a server message can echo user content.
enum Log {
